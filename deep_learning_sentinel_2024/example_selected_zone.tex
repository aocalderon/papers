...
\begin{document}
    \begin{tikzpicture}
        \node[stage] (0) at (0,0) {Zona seleccionada \\ \includegraphics[width=\defaultside, height=\defaultside]{example_selected_zone_1}};
        %\node[scale=1.5] (A) [below = 2mm of 0] {(a)};
        
        \node[stage] (1) [right = 5mm of 0] {Composición \\ \includegraphics[width=\defaultside, height=\defaultside]{example_selected_zone_2}};
        %\node[scale=1.5] (B) [below = 2mm of 1] {(b)};
        
        \node[stage] (2) [right = 5mm of 1] {Predicción \\ \includegraphics[width=\defaultside, height=\defaultside]{example_selected_zone_3}};
